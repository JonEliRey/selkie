...
The finished-package proof loads [`network-denied.ts`](../scripts/network-denied.ts)
as a network guard. It is a support module, not a standalone CLI.
